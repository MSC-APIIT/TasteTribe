  ...
  return (
    <>
      <div className="flex gap-4">
        <button className="flex w-full items-center justify-center gap-2.5 rounded-lg p-3.5 border border-input text-card-foreground bg-card hover:bg-muted transition">
          Sign Up
          <svg
            width="23"
            height="22"
